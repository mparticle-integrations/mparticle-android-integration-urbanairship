...
class UrbanAirshipKitTest2 {
    ...
    fun testParsing() {
        ...
        Assert.assertTrue(
            eventTags[245922523]?.contains("gesture") == true && eventTags[245922523]
    ...
    fun testExtractEventAttributes() {
        ...
        val event = MPEvent.Builder("search").eventType(MParticle.EventType.Search)
    ...
    fun testExtractEcommEventType() {
        ...
        kit.setUrbanConfiguration(urbanAirshipConfiguration)
        val event =
            CommerceEvent.Builder(Product.ADD_TO_CART, Product.Builder("name", "sku", 10.0).build())
                .build()
    ...
    fun testExtractEcommAttribute() {
        ...
        kit.setUrbanConfiguration(urbanAirshipConfiguration)
        val event =
            CommerceEvent.Builder(Product.PURCHASE, Product.Builder("name", "sku", 10.0).build())
